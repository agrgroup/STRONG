function [strong] = horse_xyz_to_strongs(porexyzfilename,d)
                            ...
                            if (sum(neigh_type == 'A') ~= 0)
                                ...
                                if (sum(neigh_type == 'Z') ~= 0)
                                    ...
                                    if (sum(neigh_type == 'F') ~= 0)
                                        ...
                                        if (sum(neigh_combined(row,neigh_column(k(2,1),1)) == potential_atom_index) == 0)%sum(neigh_combined(row,neigh_column(k(1,1),1)) == potential_atom_index)
                                            sequence(count,1) = neigh_combined(row,neigh_column(k(2,1),1));
                                        elseif(sum(neigh_combined(row,neigh_column(k(1,1),1)) == potential_atom_index) == 0)%sum(neigh_combined(row,neigh_column(k(2,1),1)) == potential_atom_index)
                                            sequence(count,1) = neigh_combined(row,neigh_column(k(1,1),1));
                                        else
